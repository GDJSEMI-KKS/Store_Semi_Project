...
<head>
    ...
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources_customer/css/animate.css">
    
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources_customer/css/owl.carousel.min.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources_customer/css/owl.theme.default.min.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources_customer/css/magnific-popup.css">
    
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources_customer/css/flaticon.css">
    <link rel="stylesheet" href="<%=request.getContextPath()%>/resources_customer/css/style.css">
  </head>
  <body>
  ...
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery-migrate-3.0.1.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/popper.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/bootstrap.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery.easing.1.3.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery.waypoints.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery.stellar.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/owl.carousel.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery.magnific-popup.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/jquery.animateNumber.min.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/scrollax.min.js"></script>
  <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBVWaKrjvy3MaE7SQ74_uJiULgl1JY0H2s&sensor=false"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/google-map.js"></script>
  <script src="<%=request.getContextPath()%>/resources_customer/js/main.js"></script>
