                                ...
                                <tbody>
            						...
            						%>
            								<tr>
            									...
            									<td>
            										<a href="<%=request.getContextPath()%>/admin_review/addReviewAnswr.jsp?reviewNo=<%=m.get("reviewNo")%>">답변하기</a>
            									</td>
            								</tr>
            						<%
            							}
...
. All rights reserved. Template by <a href="https://colorlib.com">Colorlib</a>.</p>
    ...
    <!-- Data Table JS
		============================================ -->
    <script src="<%=request.getContextPath()%>/resources_admin/js/data-table/jquery.dataTables.min.js"></script>
    <script src="<%=request.getContextPath()%>/resources_admin/js/data-table/data-table-act.js"></script>
    <!-- main JS
		============================================ -->
